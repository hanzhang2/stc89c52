      ...
      000000                        273 	.ds 8
                                    ...
                                    337 	.area CSEG    (CODE)
                                    338 ;------------------------------------------------------------
                                    339 ;Allocation info for local variables in function 'DelayMs'
                                    340 ;------------------------------------------------------------
                                    341 ;time                      Allocated to registers r6 r7 
                                    342 ;i                         Allocated to registers r5 
                                    343 ;j                         Allocated to registers r4 
                                    344 ;------------------------------------------------------------
                                    345 ;	../../config/config.c:2: void DelayMs(u16 time){
                                    346 ;	-----------------------------------------
                                    347 ;	 function DelayMs
                                    348 ;	-----------------------------------------
      000078                        349 _DelayMs:
                           000007   350 	ar7 = 0x07
                           000006   351 	ar6 = 0x06
                           ...
                           000001   356 	ar1 = 0x01
                           000000   357 	ar0 = 0x00
      000078 AE 82            [24]  358 	mov	r6,dpl
      00007A AF 83            [24]  359 	mov	r7,dph
                                    360 ;	../../config/config.c:4: for(i=0;i<time;i++){
      00007C 7D 00            [12]  361 	mov	r5,#0x00
      00007E                        362 00107$:
      00007E 8D 03            [24]  363 	mov	ar3,r5
      000080 7C 00            [12]  364 	mov	r4,#0x00
      000082 C3               [12]  365 	clr	c
      000083 EB               [12]  366 	mov	a,r3
      000084 9E               [12]  367 	subb	a,r6
      000085 EC               [12]  368 	mov	a,r4
      000086 9F               [12]  369 	subb	a,r7
      000087 50 0C            [24]  370 	jnc	00109$
                                    371 ;	../../config/config.c:5: for(j=0;j<100;j++){
      000089 7C 64            [12]  372 	mov	r4,#0x64
      00008B                        373 00105$:
                                    374 ;	../../config/config.c:6: _nop_;
      00008B 00               [12]  375 	nop	
      00008C EC               [12]  376 	mov	a,r4
      00008D 14               [12]  377 	dec	a
                                    378 ;	../../config/config.c:5: for(j=0;j<100;j++){
      00008E FB               [12]  379 	mov	r3,a
      00008F FC               [12]  380 	mov	r4,a
      000090 70 F9            [24]  381 	jnz	00105$
                                    382 ;	../../config/config.c:4: for(i=0;i<time;i++){
      000092 0D               [12]  383 	inc	r5
      000093 80 E9            [24]  384 	sjmp	00107$
      000095                        385 00109$:
                                    386 ;	../../config/config.c:9: }
      000095 22               [24]  387 	ret
                                    388 ;------------------------------------------------------------
                                    389 ;Allocation info for local variables in function 'DelayUs'
                                    390 ;------------------------------------------------------------
                                    391 ;i                         Allocated to registers 
                                    392 ;------------------------------------------------------------
                                    393 ;	../../config/config.c:11: void DelayUs(u16 i){
                                    394 ;	-----------------------------------------
                                    395 ;	 function DelayUs
                                    396 ;	-----------------------------------------
      000096                        397 _DelayUs:
      000096 AE 82            [24]  398 	mov	r6,dpl
      000098 AF 83            [24]  399 	mov	r7,dph
                                    400 ;	../../config/config.c:12: while(i--);
      00009A                        401 00101$:
      00009A 8E 04            [24]  402 	mov	ar4,r6
      00009C 8F 05            [24]  403 	mov	ar5,r7
      00009E 1E               [12]  404 	dec	r6
      00009F BE FF 01         [24]  405 	cjne	r6,#0xff,00111$
      0000A2 1F               [12]  406 	dec	r7
      0000A3                        407 00111$:
      0000A3 EC               [12]  408 	mov	a,r4
      0000A4 4D               [12]  409 	orl	a,r5
      0000A5 70 F3            [24]  410 	jnz	00101$
                                    411 ;	../../config/config.c:13: }
      0000A7 22               [24]  412 	ret
                                    413 	.area CSEG    (CODE)
                                    414 	.area CONST   (CODE)
                                    415 	.area XINIT   (CODE)
